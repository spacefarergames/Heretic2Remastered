//
// gl3_FlexModel.h -- Heretic 2 FlexModel type definitions for GL3 renderer.
//
...
typedef struct
{
	byte unused[MAX_FM_TRIANGLES >> 3]; // 2048 >> 3 == 256
...
// Flex model loading (stubs in gl3 -- 3D rendering not yet ported).
